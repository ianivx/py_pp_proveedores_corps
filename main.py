...
def get_fecha_de_pago_real_proveedor(row):
    fecha_de_pago_real = ''
    fecha_vencimiento = row["Vencimiento neto"]
    day = fecha_vencimiento.day
    month = fecha_vencimiento.month
...
def calcular_fechas_de_pago(is_pyme):
    ...
    # set fecha de pago real
        facturas_proveedores_df['FECHA DE PAGO REAL'] = facturas_proveedores_df.apply(get_fecha_de_pago_real_proveedor, axis=1)
